...
const COLUMNS = [
  ...
  { key: "data_points", label: "Obs" },
  { key: "daily_volatility", label: "Daily Vol" },
  { key: "annualized_volatility", label: "Ann Vol" },
  { key: "weighted_avg_volatility", label: "Weighted Avg Vol" },
  { key: "diversification_benefit", label: "Diversification %" },
  { key: "mean_daily_return", label: "Mean Daily" },
  { key: "annualized_return", label: "Ann Return" },
  { key: "daily_std", label: "Daily Std Dev" },
  { key: "min_return", label: "Worst Day" },
  { key: "max_return", label: "Best Day" },
  ...
  { key: "portfolio_beta_weighted", label: "Beta (weighted)" },
  { key: "beta_regression", label: "Beta (regression)" },
  { key: "alpha_regression", label: "Alpha" },
  { key: "r_squared", label: "R-squared" },
  { key: "correlation_with_index", label: "Correl. Index" },
];
