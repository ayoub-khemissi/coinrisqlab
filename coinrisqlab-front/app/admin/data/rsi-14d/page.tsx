...
export default function RsiPage() {
  ...
  const fetchData = async (params: Record<string, string>, pageNum: number) => {
    ...
    try {
      ...
      const res = await fetch(`/api/admin/data/rsi-14d?${query.toString()}`);
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-xl font-bold">RSI</h1>
      <DataFilters
        csvEndpoint="/api/admin/data/rsi-14d"
        csvFilename="rsi_export.csv"
        defaultDays={90}
        loading={loading}
        metric="rsi"
