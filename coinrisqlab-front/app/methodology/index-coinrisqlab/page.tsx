  ...
  return (
    <section className="flex flex-col gap-6">
      ...
      <div className="text-center md:text-left">
        <h1 className={title()}>CoinRisqLab 80 Index - Methodology</h1>
          ...
          <Card id="overview">
            <CardBody className="p-8">
              ...
              <p className="text-default-600 mb-4">
                The <strong>CoinRisqLab 80</strong> is a market-capitalization
              ...
              <p className="text-default-600">
                ...
                the CoinRisqLab 80 uses market capitalization weighting, meaning
