# CoinRisqLab 80 Index - Calculation Methodology

## Overview

The CoinRisqLab 80 is a market-capitalization weighted cryptocurrency index that tracks the performance of the top 80 cryptocurrencies, excluding stablecoins, wrapped tokens, and staked tokens.
...
**Reference:** `calculateCoinRisqLab80.js:74-148`
...
**Reference:** `calculateCoinRisqLab80.js:153-212`
...
|----------------|---------------|----------|
| **Stablecoins** | categories includes "stablecoin" | USDT, USDC, DAI |
| **Wrapped Tokens** | categories includes "wrapped" | WBTC, WETH |
| **Staked** | categories includes "staking" or "staked" | stETH, rETH |
...
**Reference:** `calculateCoinRisqLab80.js:35`
...
**Reference:** `calculateCoinRisqLab80.js:39`
...
**Reference:** `calculateCoinRisqLab80.js:266-267`
...
- **Staked:** Derivative tokens that would create double-counting
...
### Code Location
`coinrisqlab-back/commands/calculateCoinRisqLab80.js`

### Main Functions
- `calculateCoinRisqLab80()` - Main orchestration function
...
- Index calculation implementation: `coinrisqlab-back/commands/calculateCoinRisqLab80.js`
- Exclusion logic: `coinrisqlab-back/utils/exclusions.js`
